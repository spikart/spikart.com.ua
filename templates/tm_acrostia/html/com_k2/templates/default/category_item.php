...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
		...
		<span class="catItemDateCreated">
			<span class="day"><?php echo JHTML::_('date', $this->item->created , JText::_('j')); ?></span>
  ...
  <div class="catItemBody">
	  ...
	  <?php if($this->item->params->get('catItemAuthor')): ?>
		...
		<div class="catItemCategory">
			...
			<i class="icon-folder-close"></i><a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
		</div>
		<?php endif; ?>
	  ...
	  <div class="catItemTagsBlock">
		  ...
		  <ul class="catItemTags">
		    <i class="icon-tags"></i><?php foreach ($this->item->tags as $tag): ?>
	...
	<div class="catItemCommentsLink">
		<i class="icon-comment"></i><?php if(!empty($this->item->event->K2CommentsCounter)): ?>
  ...
  <?php endif; ?>
	...
	<div class="catItemReadMore">
		<a class="btn btn-primary k2ReadMore readmore" href="<?php echo $this->item->link; ?>">
	...
	<?php endif; ?>
		...
		<div class="catItemHitsBlock">
			<span class="catItemHits">
				<i class="icon-heart"></i><?php // echo JText::_('K2_READ'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); ?>
			</span>
		</div>
		<?php endif; ?>
